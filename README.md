...
### Facebook CEO의 프로젝트로 탄생한 '자비스'의 기능과 발전 소개
...
### 김민지
### 뉴스 요약
마크 저커버그가 만든 AI 비서 '자비스'에 대한 내용으로 이 프로젝트를 진행하면서 그가 배우고 느낀점에 대해 기술
### 느낀 점
AI 비서 하나를 만드는데 다양한 기술이 사용되고 각각 어떤 역할을 하는지 조금이나마 알게됐다.

---
### 정영진
### 뉴스 요약
마크 저커버크가 만든 AI 비서 자비스에 대한 소개이고 이에 대한 저커버크에 생각과 발전가능성을 정리한 글이다.
### 느낀점
자연어 처리와 음성인식 기술의 발전으로 비서를 대체하는 AI비서가 만들어진 것이 놀라웠고, 마크 저커버크와 마찬가지로 나 역시 아직 발전 가능성이 많다고 생각한다.
